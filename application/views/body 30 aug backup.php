...
<meta itemprop="name" content="Home-Diros">
<meta itemprop="description" content="An Effective Way for DP Battle.. Easy to use.. Try Us For DP Battle">
...
<meta property="og:title" content="Home-Diros">
...
<meta property="og:image" content="<?=base_url('utility/meta_img/').$meta_img->meta_img;?>">
...
<!-- 	<div class="cover_img w-35" style="" id="cover_img">
		
	</div> -->
	<div class="d-flex justify-content-center" style="max-width: 90%; margin:auto;">
...
?>
<div class="row">
<div class="col text-center text-md-left pl-3 pl-md-5" style='background:#d92027; font-size:30px; color:white; margin:0px; height: 50px;'>This Battle is not Active</div>
	</div>
<?php
}
?>
		...
		<div class="page-container">
			<div class="section header" data-name="Page Content" data-lead-id="competition-page_0_Page-Content_container">
...
<h5 class="mt-1 ml-2 " >Share Battle:-</h5>
...
<a class="a2a_button a2a_dd" ></a>
	...
	<div class="col-3 col-md-5 pl-3 p-0 mb-1" style=" ">
		<a href="<?=base_url("home?battle_id=$random_battle_id->id");?>"><div class="btn btn-info float-right m-0 next_battle_top" style="">NeXT BaTTle</div></a>
	</div>
</div>
...
<?php
	if(!empty($vote_update_data=$this->session->flashdata('voteing_status'))){
									  ...
									  <div class="col-6 p-sm-3 user_card_box" data-id="<?=$fighters->username;?>" style="margin-top: 15px; margin:0px; padding: 0px; ">
									    <div class="card" style="box-shadow: 5px 5px 10px rgb(179,52,147,0.3);">
									      <div class="card-body"  style="background: #ffc7c7; padding: 0px; display: flex; flex-direction: column; display: inline-block;">
									        ...
									        <img src="https://i1.wp.com/www.pngall.com/wp-content/uploads/2016/04/Winner-Free-PNG-Image.png" height="150" style="position: absolute; z-index: 2; top: 60%; opacity: 0.7; right: 0%; width: 60%; height: auto;  display: <?=$display_watermark;?> " >
									        <?php
									    endif;
									    endif;
										...
										<a href='<?=base_url("home/stats?battle_id=$battle_id&&user=$fighters->username");?>'>
									        <div class="badge badge-info m-2 float-right" style="font-size: 12px; font-weight: normal;">Stats</div>
									    </a>
									        </h2>
										...
										<div style="overflow: auto; background: linear-gradient(46deg ,#F15F79,#ffc7c7,#F15F79);">
											<ul class="social_ul" style="margin-bottom: 15px; margin-top:8px;">
											  ...
											  <li class="social_li" onclick="social_track_insert('<?=$battle_id;?>','<?=$fighters->username;?>','facebook')">
											    <a class="social_a" target="blank" style="background: black; color:red;"href="<?=$fighters->fb_id;?>">
											 ...
											 <?php endif;
											  ...
											  <li class="social_li" onclick="social_track_insert('<?=$battle_id;?>','<?=$fighters->username;?>','instagram')">
											    <a class="social_a" target="blank"  href="<?=$fighters->insta_id;?>" style="background: black;">
											  ...
											  <li class="social_li" onclick="social_track_insert('<?=$battle_id;?>','<?=$fighters->username;?>','tiktok')">
											    <a class="social_a" target="blank"  href="<?=$fighters->tiktok_id;?>">
	 ...
	 <a class="btn btn-danger " href='<?=base_url("home?battle_id=$random_battle_id_over->id")?>' id="vote_btn" style="background: linear-gradient(45deg, #d5135a, #f05924); box-shadow: 0px 4px 30px rgba(223, 45, 70, 0.35);">Completed Battles (Random)</a>
							...
							<div data-name="Column 2" data-lead-id="competition-page_8_Column-2_container" class="col-md-4" >
								...
								<h5><?=ucfirst($admin_data->admin_full_name);?></h5>
									<a target="blank" class="btn btn-primary" style="width: 80%; " href="<?=$admin_data->group_id;?>" data-name="Subtitle #1" data-lead-id="competition-page_17_Subtitle-#1_text">Admin's Battle Group</a>
								...
								<div class="rows p-3 mb-3   text-center" style="background: #3f3f44; ">
									...
									<!-- 	<div class="col ">
										...
										<div class="col">
											<a href="https://wa.me/919110065497" target="blank" class="btn btn-success" style="height: 80px;">


	 										 <li class="social_li" style="margin-top: -15px; margin-left: -15px;">
											      <i class="fab fa-whatsapp" style="font-size: 30px;"> <span style="font-size: 16px;"> Register On Whatsapp</span></i>    
											  </li>
									...
									<a target="blank" href="https://www.facebook.com/groups/732525747484692/" style="text-decoration:none; height: 80px;">	
										<div class="col" style="color: white;"><b>Facebook Group</b></div>
			...
			<footer class="section footer" data-name="Footer" data-lead-id="competition-page_34_Footer_container">
				<div class="container text-center">
					...
					<ul data-name="Fine Print" data-lead-id="competition-page_36_Fine-Print_container">
						<li data-name="Copyright" data-lead-id="competition-page_37_Copyright_text">© 2020 <b style="font-size: 26px;">Diros</b>.</li>
						<li data-name="Legal" data-lead-id="competition-page_38_Legal_text"><a href="#">Legal Information</a></li>
					</ul>
				</div>
			</footer>
		</div>
